...
const questions = [
  ...
  {
    id: "fixture-question-product-market-entry-case-v1",
    slug: "product-market-entry-case",
    version: 1,
    prompt:
      "A digital-service product is considering a new Kenyan customer segment with limited support capacity. How would you structure the case, choose evidence, and recommend whether to proceed?",
    ...
    signals: [
      "Structures the case into customer, business, operational, and delivery questions.",
      "Identifies evidence needed before recommending a rollout.",
      "Names risks, trade-offs, and a practical decision path.",
    ],
    redFlags: [
      "Recommends launching without evidence or assumptions.",
      "Ignores support capacity, adoption risk, or customer trust.",
    ],
    followUps: [
      {
        intent: "assumptions",
        condition: "The candidate does not state assumptions.",
        promptHint: "Which assumption would you test before recommending launch?",
      },
      {
        intent: "evidence",
        condition: "The recommendation is not supported by evidence.",
        promptHint: "What evidence would change your recommendation?",
      },
      {
        intent: "risks",
        condition: "The answer does not name rollout risks.",
        promptHint: "What could go wrong if support capacity is lower than expected?",
      },
    ],
  },
  {
  ...
  {
    id: "fixture-question-load-balancer-design-v1",
    slug: "load-balancer-system-design",
    version: 1,
    prompt:
      "Design a simple load balancer for a busy API. What assumptions would you make, how would traffic flow, and how would you keep it reliable when one server fails?",
    frameworkKey: "system_design",
    rubricKey: "technical_concept_v1",
    industrySlug: null,
    difficulty: "graduate-entry",
    ...
    competencySlugs: ["systems-thinking", "technical-fundamentals", "problem-solving"],
    signals: [
      "States assumptions about traffic, stateless app servers, and request flow.",
      "Uses health checks, routing policy, timeouts, and retry behavior appropriately.",
      "Names reliability, observability, scaling, and trade-off considerations.",
    ],
    redFlags: [
      "Treats a load balancer as a database or storage layer.",
      "Assumes one routing algorithm solves all reliability problems.",
    ],
    followUps: [
      {
        intent: "assumptions",
        condition: "The candidate starts designing without requirements or assumptions.",
        promptHint: "What traffic and failure assumptions would you clarify first?",
      },
      {
        intent: "mechanism",
        condition: "The candidate names a load balancer without explaining request flow.",
        promptHint: "Walk me through one request from client to healthy server and back.",
      },
      {
        intent: "risks",
        condition: "The design does not discuss server failure or overload.",
        promptHint: "What happens when one backend becomes unhealthy or overloaded?",
      },
    ],
  },
] as const;
...
const plans = [
  ...
  {
    id: "fixture-plan-safaricom-pm-role-specific-mid-v1",
    slug: "scenario-a-safaricom-product-manager-role-specific-mid-level",
    version: 1,
    ...
    senioritySlug: "mid-level",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-scenario-a-product-manager-role-specific-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Scenario A role-specific Product Manager plan covering product, analytics, case, and role-knowledge evaluation.",
    modules: [
      {
        id: "fixture-plan-module-pm-role-product-case",
        frameworkKey: "product_case",
        competencySlug: "product-prioritization",
        weight: 35,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-pm-role-analytics",
        frameworkKey: "analytics_case",
        competencySlug: "metrics-analytics",
        weight: 25,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-pm-role-case-study",
        frameworkKey: "case_study",
        competencySlug: "product-prioritization",
        weight: 25,
        displayOrder: 30,
      ...
      {
        id: "fixture-plan-module-pm-role-knowledge",
        frameworkKey: "role_knowledge",
        competencySlug: "stakeholder-communication",
        weight: 15,
        displayOrder: 40,
  ...
  {
    id: "fixture-plan-kenya-pm-recommended-mid-v1",
    slug: "role-fallback-product-manager-recommended-mid-level",
    version: 1,
    focusMode: "recommended",
    marketSlug: "kenya",
    companySlug: null,
    ...
    senioritySlug: "mid-level",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-product-manager-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Product Manager fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-pm-fallback-mid-behavioral",
        frameworkKey: "behavioral_star",
        competencySlug: "ownership",
        weight: 30,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-pm-fallback-mid-product",
        frameworkKey: "product_case",
        competencySlug: "product-prioritization",
        weight: 25,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-pm-fallback-mid-analytics",
        frameworkKey: "analytics_case",
        competencySlug: "metrics-analytics",
        weight: 20,
        displayOrder: 30,
      ...
      {
        id: "fixture-plan-module-pm-fallback-mid-role",
        frameworkKey: "role_knowledge",
        competencySlug: "stakeholder-communication",
        weight: 15,
        displayOrder: 40,
      ...
      {
        id: "fixture-plan-module-pm-fallback-mid-general",
        frameworkKey: "general",
        competencySlug: "customer-empathy",
        weight: 10,
        displayOrder: 50,
  ...
  {
    id: "fixture-plan-kenya-pm-behavioral-mid-v1",
    slug: "role-fallback-product-manager-behavioral-focus-mid-level",
    version: 1,
    ...
    senioritySlug: "mid-level",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-product-manager-behavioral-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Product Manager behavioral fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-pm-fallback-behavioral-star",
        frameworkKey: "behavioral_star",
        competencySlug: "ownership",
        weight: 70,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-pm-fallback-behavioral-role",
        frameworkKey: "role_knowledge",
        competencySlug: "stakeholder-communication",
        weight: 20,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-pm-fallback-behavioral-general",
        frameworkKey: "general",
        competencySlug: "customer-empathy",
        weight: 10,
        displayOrder: 30,
  ...
  {
    id: "fixture-plan-kenya-pm-role-specific-mid-v1",
    slug: "role-fallback-product-manager-role-specific-mid-level",
    version: 1,
    focusMode: "role_specific_focus",
    marketSlug: "kenya",
    companySlug: null,
    ...
    senioritySlug: "mid-level",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-product-manager-role-specific-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Product Manager role-specific fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-pm-fallback-role-product-case",
        frameworkKey: "product_case",
        competencySlug: "product-prioritization",
        weight: 35,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-pm-fallback-role-analytics",
        frameworkKey: "analytics_case",
        competencySlug: "metrics-analytics",
        weight: 25,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-pm-fallback-role-case-study",
        frameworkKey: "case_study",
        competencySlug: "product-prioritization",
        weight: 25,
        displayOrder: 30,
      ...
      {
        id: "fixture-plan-module-pm-fallback-role-knowledge",
        frameworkKey: "role_knowledge",
        competencySlug: "stakeholder-communication",
        weight: 15,
        displayOrder: 40,
  ...
  {
    id: "fixture-plan-kenya-se-recommended-graduate-v1",
    slug: "role-fallback-software-engineering-recommended-graduate-entry",
    version: 1,
    focusMode: "recommended",
    marketSlug: "kenya",
    companySlug: null,
    ...
    senioritySlug: "graduate-entry",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-software-engineering-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Software Engineering fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-se-fallback-rec-behavioral",
        frameworkKey: "behavioral_star",
        competencySlug: "ownership",
        weight: 30,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-se-fallback-rec-technical",
        frameworkKey: "technical_concept",
        competencySlug: "technical-fundamentals",
        weight: 40,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-se-fallback-rec-role",
        frameworkKey: "role_knowledge",
        competencySlug: "collaboration",
        weight: 20,
        displayOrder: 30,
      ...
      {
        id: "fixture-plan-module-se-fallback-rec-general",
        frameworkKey: "general",
        competencySlug: "stakeholder-communication",
        weight: 10,
        displayOrder: 40,
  ...
  {
    id: "fixture-plan-kenya-se-behavioral-graduate-v1",
    slug: "role-fallback-software-engineering-behavioral-focus-graduate-entry",
    version: 1,
    focusMode: "behavioral_focus",
    marketSlug: "kenya",
    companySlug: null,
    ...
    senioritySlug: "graduate-entry",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-software-engineering-behavioral-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Software Engineering behavioral fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-se-fallback-behavioral-star",
        frameworkKey: "behavioral_star",
        competencySlug: "ownership",
        weight: 70,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-se-fallback-behavioral-situational",
        frameworkKey: "situational",
        competencySlug: "collaboration",
        weight: 20,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-se-fallback-behavioral-general",
        frameworkKey: "general",
        competencySlug: "stakeholder-communication",
        weight: 10,
        displayOrder: 30,
  ...
  {
    id: "fixture-plan-kenya-se-technical-graduate-v1",
    slug: "role-fallback-software-engineering-technical-concept-graduate-entry",
    version: 1,
    focusMode: "role_specific_focus",
    marketSlug: "kenya",
    companySlug: null,
    ...
    senioritySlug: "graduate-entry",
    promptVersion: "jr-interview-prompt-v1",
    questionSetVersion: "jr-role-fallback-software-engineering-technical-v1",
    rubricVersion: "jr-rubric-v1",
    rationale:
      "Company-neutral Software Engineering technical fallback for unsupported or other-company onboarding.",
    modules: [
      {
        id: "fixture-plan-module-se-fallback-tech-concept",
        frameworkKey: "technical_concept",
        competencySlug: "technical-fundamentals",
        weight: 70,
        displayOrder: 10,
      ...
      {
        id: "fixture-plan-module-se-fallback-tech-system",
        frameworkKey: "system_design",
        competencySlug: "systems-thinking",
        weight: 20,
        displayOrder: 20,
      ...
      {
        id: "fixture-plan-module-se-fallback-tech-role",
        frameworkKey: "role_knowledge",
        competencySlug: "problem-solving",
        weight: 10,
        displayOrder: 30,
...
export async function seedJobreadyReferenceFixtures(prisma: PrismaClient) {
  ...
  for (const plan of plans) {
    let planCompanyId: string | null = null;
    if (plan.companySlug === "safaricom") {
      planCompanyId = company.id;
    }
